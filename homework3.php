...
try {
	...
	array_push($sql,'Select dept_manager.dept_no, dept_manager.emp_no, employees.first_name, employees.last_name, dept_manager.to_date from dept_manager left join employees on dept_manager.emp_no=employees.emp_no where to_data = \'9999-01-01\'');
	...
	array_push($sql,'Select * from employees left join salaries on employees.emp_no=salaries.emp_no where to_data=\'9999-01-01\' order by salary ASC limit 5');
